...
const ProgressBar = ({ value }) => {
    const progressBarStyles = {
      ...
      borderRadius: '5px',
      transition: 'width 0.5s ease', // Optional: Add a smooth transition effect
    };
    ...
    const containerStyles = {
      ...
      borderRadius: '5px',
      marginTop: '10px',
      overflow: 'hidden', // Hide the overflow to prevent rounding issues
    };
...
const ProductDetails = () => {
    ...
    const { images, title, info, category, finalPrice, originalPrice, ratings, rateCount, eco } = product;
                    ...
                    <div className="wrapper prod_details_wrapper">
                        ...
                        <div className="prod_details_right_col">
                            ...
                            <div className="prod_details_offers">
                                <h4>Eco Value</h4>
                                <ul>
                                    <li>The closer the score is to 100, the better the sustainability performance of the device            
            <ProgressBar value={eco} /></li>
                                </ul>
                            </div>
