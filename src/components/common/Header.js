            ...
            <header id="header" className={isSticky ? 'sticky' : ''}>
                <div className="container">
                    <div className="navbar">
                        ...
                        <div className="search_action" onClick={() => navigateToDashPage()}>
                        <SiGoogleanalytics />
                                <div className="tooltip">DashBoard</div>
                            </div>
                        <div className="search_action" onClick={() => navigateToEcoRatingPage()}>
                                <FaLeaf />
                                <div className="tooltip">EcoRating</div>
                            </div>
